...
@Component({
  selector: 'lib-fetch-and-scroll',
  templateUrl: './fetch-and-scroll.component.html',
  styleUrls: ['./fetch-and-scroll.component.scss'],
})
export class FetchAndScrollComponent {
  ...
  @HostListener('document:click', ['$event']) onDocumentClick(event: any) {
    ...
    this.onClickOutside.emit(); // if it is in form and required
  }
  ...
  onSearch(event: Event) {
    ...
    const searchTag = (event.target as HTMLInputElement).value;
